...
<button on:click={toggleBookmark} class="fixed right-4 bottom-4 rounded-[50%] bg-blue-500 text-white w-[50px] h-[50px] flex items-center justify-center shadow-lg hover:bg-blue-600 transition-colors">
	{#if bookmarked}
